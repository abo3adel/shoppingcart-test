...
/* harmony import */ var _super__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./super */ "./resources/js/pages/super.ts");
...
var Home = /** @class */ (function (_super) {
    ...
    Home.prototype.addToCart = function (id, instance) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.post("/cart/" + id, { instance: instance }).then(function (res) {
            ...
            // }
            _this.d[instance].push(res.data);
            if (_this.d.activeInstance === instance) {
                _this.d.activeList.push(res.data);
            }
            _this.successMes();
            loader.add("d-none");
        });
    ...
    Home.prototype.changeInstance = function (instance) {
        ...
        if (instance === "wishlist") {
            this.d.activeList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(this.d.wishlist);
        }
        else if (instance === "compare") {
            this.d.activeList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(this.d.compare);
        }
        else {
            this.d.activeList = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(this.d.default);
        }
    };
    ...
    return Home;
}(_super__WEBPACK_IMPORTED_MODULE_3__["default"]));
...
__webpack_require__(/*! D:\laragon\www\shoppingcart-test\resources\js\app.ts */"./resources/js/app.ts");
module.exports = __webpack_require__(/*! D:\laragon\www\shoppingcart-test\resources\sass\app.scss */"./resources/sass/app.scss");
